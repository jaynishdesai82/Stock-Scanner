...
with tab_scanner:
    ...
    if run_scan:
        ...
        with st.spinner(f"Synchronizing {len(ticker_list)} unique stocks from {index_choice}..."):
    ...
    if not st.session_state['scan_results'].empty:
        ...
        st.info("Scanner results will appear here. Click 'RUN MARKET SCAN' in the sidebar to begin.")
